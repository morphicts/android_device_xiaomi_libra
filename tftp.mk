...
$(shell ln -s /data/hlos_rfs/shared $(TARGET_OUT)/rfs/msm/mpss/hlos)
...
$(shell ln -s /data/hlos_rfs/shared $(TARGET_OUT)/rfs/msm/adsp/hlos)
...
$(shell ln -s /data/rfs/mdm/mpss $(TARGET_OUT)/rfs/mdm/mpss/readwrite)
$(shell ln -s /data/rfs/shared $(TARGET_OUT)/rfs/mdm/mpss/shared)
$(shell ln -s /data/hlos_rfs/shared $(TARGET_OUT)/rfs/mdm/mpss/hlos)
...
$(shell ln -s /data/rfs/mdm/adsp $(TARGET_OUT)/rfs/mdm/adsp/readwrite)
$(shell ln -s /data/rfs/shared $(TARGET_OUT)/rfs/mdm/adsp/shared)
$(shell ln -s /data/hlos_rfs/shared $(TARGET_OUT)/rfs/mdm/adsp/hlos)
...
$(shell ln -s /data/rfs/mdm/sparrow $(TARGET_OUT)/rfs/mdm/sparrow/readwrite)
$(shell ln -s /data/rfs/shared $(TARGET_OUT)/rfs/mdm/sparrow/shared)
$(shell ln -s /data/hlos_rfs/shared $(TARGET_OUT)/rfs/mdm/sparrow/hlos)
...
$(shell ln -s /data/rfs/apq/gnss $(TARGET_OUT)/rfs/apq/gnss/readwrite)
$(shell ln -s /data/rfs/shared $(TARGET_OUT)/rfs/apq/gnss/shared)
$(shell ln -s /data/hlos_rfs/shared $(TARGET_OUT)/rfs/apq/gnss/hlos)
